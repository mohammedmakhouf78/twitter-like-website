    ...
    <div>
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="landing.html" title="">Login page</a>
                            </li>
                            <li>
                                <a href="logout.html" title="">Logout Page</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="groups.html" title="">groups page</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="messages.html" title="">message box</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="forum.html" title="">Forum Page</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="shop.html" title="">Shop Products</a>
                            </li>
                            <li>
                                <a href="shop-masonry.html" title=""
                                    >Shop Masonry Products</a
                                >
                            </li>
                            <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="blog-list-right-sidebar.html" title=""
                                    >Blog List with R-Sidebar</a
                                >
                            </li>
                            <li>
                                <a href="blog-list-left-sidebar.html" title=""
                                    >Blog List with L-Sidebar</a
                                >
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="404.html" title="">404 error page</a>
                            </li>
                            <li>
                                <a href="404-2.html" title="">404 Style2</a>
                            </li>
                    ...
                    <li>
                        <a href="contact-branches.html" title="">Contact Us2</a>
                    </li>
        ...
        <div class="topbar stick">
            ...
            <div class="top-area">
                ...
                <ul class="setting-area">
                    ...
                    <li>
                        ...
                        <div class="dropdowns">
                            ...
                            <a href="messages.html" title="" class="more-mesg"
                                >view more</a
                            >
                        </div>
                    </li>
                ...
                <div class="user-img">
                    <img src="/site/images/resources/admin.jpg" alt="" />
