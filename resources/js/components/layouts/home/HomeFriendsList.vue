    ...
    <div class="widget friend-list stick-widget">
        ...
        <ul id="people-list" class="friendz-list">
            <li>
                <figure>
                    <img
                        src="/site/images/resources/friend-avatar.jpg"
                        alt=""
                    />
            ...
            <li>
                <figure>
                    <img
                        src="/site/images/resources/friend-avatar5.jpg"
                        alt=""
                    />
                    <span class="status f-online"></span>
                </figure>
            ...
            <li>
                <figure>
                    <img
                        src="/site/images/resources/friend-avatar7.jpg"
                        alt=""
                    />
                    <span class="status f-off"></span>
                </figure>
                ...
                <ul>
                    <li class="me">
                        <div class="chat-thumb">
                            <img
                                src="/site/images/resources/chatlist1.jpg"
                                alt=""
                            />
                        </div>
                    ...
                    <li class="you">
                        <div class="chat-thumb">
                            <img
                                src="/site/images/resources/chatlist2.jpg"
                                alt=""
                            />
                        </div>
                        <div class="notification-event">
