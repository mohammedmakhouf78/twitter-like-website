<div class="responsive-header">
    <div class="mh-head first Sticky">
        ...
        <span class="mh-text">
            <a href="newsfeed.html" title=""><img src="{{asset('site')}}/images/logo2.png" alt=""></a>
        </span>
...
<div class="topbar stick">
    <div class="logo">
        <a title="" href="newsfeed.html"><img src="{{asset('site')}}/images/logo.png" alt=""></a>
    </div>
    ...
    <div class="top-area">
                    ...
                    <ul class="drops-menu">
                        <li>
                            <a href="notifications.html" title="">
                                <img src="{{asset('site')}}/images/resources/thumb-1.jpg" alt="">
                                <div class="mesg-meta">
                                    <h6>sarah Loren</h6>
                        ...
                        <li>
                            <a href="notifications.html" title="">
                                <img src="{{asset('site')}}/images/resources/thumb-2.jpg" alt="">
                                <div class="mesg-meta">
                                    <h6>Jhon doe</h6>
                                    <span>Hi, how r u dear ...?</span>
                                    <i>2 min ago</i>
                        ...
                        <li>
                            <a href="notifications.html" title="">
                                <img src="{{asset('site')}}/images/resources/thumb-3.jpg" alt="">
                                <div class="mesg-meta">
                                    <h6>Andrew</h6>
                                    <span>Hi, how r u dear ...?</span>
                                    <i>2 min ago</i>
                        ...
                        <li>
                            <a href="notifications.html" title="">
                                <img src="{{asset('site')}}/images/resources/thumb-4.jpg" alt="">
                                <div class="mesg-meta">
                                    <h6>Tom cruse</h6>
                                    <span>Hi, how r u dear ...?</span>
                                    <i>2 min ago</i>
                        ...
                        <li>
                            <a href="notifications.html" title="">
                                <img src="{{asset('site')}}/images/resources/thumb-5.jpg" alt="">
                                <div class="mesg-meta">
                                    <h6>Amy</h6>
                                    <span>Hi, how r u dear ...?</span>
                                    <i>2 min ago</i>
        ...
        <div class="user-img">
            <img src="{{asset('site')}}/images/resources/admin.jpg" alt="">
