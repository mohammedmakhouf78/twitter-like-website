<div class="widget friend-list stick-widget">
    ...
    <ul id="people-list" class="friendz-list">
        <li>
            <figure>
                <img src="{{asset('site')}}/images/resources/friend-avatar.jpg" alt="">
        ...
        <li>
            <figure>
                <img src="{{asset('site')}}/images/resources/friend-avatar2.jpg" alt="">
        ...
        <li>
            <figure>
                <img src="{{asset('site')}}/images/resources/friend-avatar3.jpg" alt="">
        ...
        <li>
            <figure>
                <img src="{{asset('site')}}/images/resources/friend-avatar4.jpg" alt="">
                <span class="status f-off"></span>
            </figure>
            <div class="friendz-meta">
        ...
        <li>
            ...
            <figure>
                <img src="{{asset('site')}}/images/resources/friend-avatar5.jpg" alt="">
                <span class="status f-online"></span>
            </figure>
            <div class="friendz-meta">
        ...
        <li>
            ...
            <figure>
                <img src="{{asset('site')}}/images/resources/friend-avatar6.jpg" alt="">
                <span class="status f-away"></span>
            </figure>
            <div class="friendz-meta">
        ...
        <li>
            ...
            <figure>
                <img src="{{asset('site')}}/images/resources/friend-avatar7.jpg" alt="">
                <span class="status f-off"></span>
            </figure>
            <div class="friendz-meta">
    ...
    <div class="chat-box">
        ...
        <div class="chat-list">
            <ul>
                <li class="me">
                    <div class="chat-thumb"><img src="{{asset('site')}}/images/resources/chatlist1.jpg" alt=""></div>
                    <div class="notification-event">
                        <span class="chat-message-item">
                            Hi James! Please remember to buy the food for tomorrow! I’m gonna be handling the gifts and
                ...
                <li class="you">
                    <div class="chat-thumb"><img src="{{asset('site')}}/images/resources/chatlist2.jpg" alt=""></div>
                    <div class="notification-event">
                        <span class="chat-message-item">
                            Hi James! Please remember to buy the food for tomorrow! I’m gonna be handling the gifts and
                            Jake’s gonna get the drinks
