                    ...
                    <div class="row" id="page-contents">
                        <div class="col-lg-3">
                            <aside class="sidebar static">
                                ...
                                @include('site.layouts.homeShortCuts')





                                @include('site.layouts.homeRecentActivities')
                                ...
                                @include('site.layouts.homeWhoIsFollowing')
                            </aside>
                        </div><!-- sidebar -->
                        <div class="col-lg-6">
                            <div class="central-meta">
                                <div class="new-postbox">
                                    <figure>
                                        <img src="{{asset('site')}}/images/resources/admin2.jpg" alt="">
                                    </figure>
                            ...
                            <div class="loadMore">
                                <div class="central-meta item">
                                    <div class="user-post">
                                        <div class="friend-info">
                                            <figure>
                                                <img src="{{asset('site')}}/images/resources/friend-avatar10.jpg"
                                                    alt="">
                                            </figure>
                                            ...
                                            <div class="post-meta">
                                                <img src="{{asset('site')}}/images/resources/user-post.jpg" alt="">
                                            ...
                                            <ul class="we-comet">
                                                <li>
                                                    <div class="comet-avatar">
                                                        <img src="{{asset('site')}}/images/resources/comet-1.jpg"
                                                            alt="">
                                                    </div>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <div class="comet-avatar">
                                                                <img src="{{asset('site')}}/images/resources/comet-2.jpg"
                                                                    alt="">
                                                            </div>
                                                            <div class="we-comment">
                                                                <div class="coment-head">
                                                        ...
                                                        <li>
                                                            <div class="comet-avatar">
                                                                <img src="{{asset('site')}}/images/resources/comet-3.jpg"
                                                                    alt="">
                                                            </div>
                                                            <div class="we-comment">
                                                                <div class="coment-head">
                                ...
                                <div class="central-meta item">
                                    <div class="user-post">
                                        <div class="friend-info">
                                            <figure>
                                                <img src="{{asset('site')}}/images/resources/nearly1.jpg" alt="">
                                            </figure>
                                            <div class="friend-name">
                                ...
                                <div class="central-meta item">
                                    <div class="user-post">
                                        <div class="friend-info">
                                            <figure>
                                                <img src="{{asset('site')}}/images/resources/nearly6.jpg" alt="">
                                            </figure>
                                            <div class="friend-name">
                                ...
                                <div class="central-meta item">
                                    <div class="user-post">
                                        <div class="friend-info">
                                            <figure>
                                                <img alt=""
                                                    src="{{asset('site')}}/images/resources/friend-avatar10.jpg">
                                            </figure>
                                            <div class="friend-name">
                                            ...
                                            <div class="post-meta">
                                                <div class="linked-image align-left">
                                                    <a title="" href="#"><img alt=""
                                                            src="{{asset('site')}}/images/resources/page1.jpg"></a>
                                                </div>
                                                <div class="detail">
                        ...
                        <div class="col-lg-3">
                            <aside class="sidebar static">
                                ...
                                @include('site.layouts.homeYourPage')





                                @include('site.layouts.homeBanner')





                                @include('site.layouts.homeFriendsList')
